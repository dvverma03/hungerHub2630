        ...
        <>
            <div className="flex justify-between bg-pink-500 sticky top-0 z-10">
                ...
                <div className="list-none flex relative">
                    {!islogin && <li className="list-none flex relative">
                ...
                <div className="w-24 m-4 p-2">
                    {
                        islogin ? (<button className="w-24 px-4 py-[5px] rounded-md bg-[#66cc52] hover:font-bold" ><Link to="/" onClick={() => setIslogin(false)}>Login</Link></button>) :
